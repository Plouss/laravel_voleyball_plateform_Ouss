...
<section class="container ">
    <div class="container mt-5 ">
        <h3 class="text-white text-center">Nouveau joueur</h3>
        <form action="/joueur" style="font-size: 18px" method="POST" class="form-control w-100 m-auto" enctype="multipart/form-data">
            @csrf
...
<div class="mb-3">
        ...
        <table class="table mt-5 table-light  w-100 m-auto">
            <thead>
                <tr class="bg-warning">
