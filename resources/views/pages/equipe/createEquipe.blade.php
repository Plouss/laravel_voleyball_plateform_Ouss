...
@if (session()->has('message'))
    ...
    <section class="container">
        <div class="container mt-5  mb-3">
            <h3 class="text-white text-center">Nouvelle équipe</h3>

            <form action="/equipe" style="font-size: 18px" class="form-control w-100 m-auto" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="mb-1">
            ...
            <table class="table mt-5 w-100 m-auto">
                <thead>
                    <tr>
